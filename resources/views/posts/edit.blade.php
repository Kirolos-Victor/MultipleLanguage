    ...
    <div class="container">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{trans('content.updatepost')}}</h3>
                        ...
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <div class="tab-pane fade {{$loop->index ==0 ?'show active':''}}" id="{{$localeCode}}" role="tabpanel" aria-labelledby="{{$localeCode}}-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="title[{{$localeCode}}]" type="text" id="inputName" class="form-control" value="{{old('title.'.$localeCode,$post->getTranslation('title',$localeCode))}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="body[{{$localeCode}}]" id="inputDescription" class="form-control" rows="4" >{{old('body.'.$localeCode,$post->getTranslation('body',$localeCode))}}</textarea>
